            ...
            <div className={styles.big_conteiner}>
                ...
                <div className={styles.conteiner}>
                    ...
                    <div className={styles.term}>
                            ...
                            <input type="text" name="pr" className={`${styles.input} ${styles.input_mail}`} placeholder=" Процент готовности"/>
                                <button className ={styles.btn}><span className ={styles.txakk}>Обновить</span></button> 
                        </div>
                        <div className={styles.percent}>
                                <p className={styles.percent_text1}>Процент готовности дипломов студентов</p>
