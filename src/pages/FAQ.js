            ...
            <div className={styles.big_conteiner}>
                ...
                <div className={styles.conteiner}>
                    ...
                    <div className={styles.dip_box2}>
                        ...
                        <p className={styles.dip_text2} onClick={() => setAnswer3(!answer3)}>Ответ</p>
                    </div>
                    <div className={styles.dip_box2}>
                        <p className={styles.text1}>Какой то вопрос</p>
                        ...
                        <p className={styles.dip_text2} onClick={() => setAnswer4(!answer4)}>Ответ</p>
                    </div>
                    <div className={styles.dip_box2}>
                        <p className={styles.text1}>Какой то вопрос</p>
                        ...
                        <p className={styles.dip_text2} onClick={() => setAnswer5(!answer5)}>Ответ</p>
                    </div>
                    </div>
